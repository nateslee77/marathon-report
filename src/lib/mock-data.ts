...
export const detailedPlayers: Record<string, DetailedPlayer> = {
  'player-001': {
    ...
    careerHighlights: [
      { label: 'Highest Kill Game', value: '32 kills' },
      { label: 'Longest Extract Streak', value: '12 matches' },
      { label: 'Fastest Extraction', value: '4:12' },
      { label: 'Most Damage (single)', value: '5,840' },
    ],
    stats: {
      overall: { matchesPlayed: 342, winRate: 68.4, kd: 1.87, kda: 2.34, averageKills: 14.2, averageDeaths: 7.6, extractionRate: 42.1, bestStreak: 12, currentStreak: 3, timePlayed: '127h 43m' },
      last10: { matchesPlayed: 10, winRate: 70.0, kd: 1.92, kda: 2.41, averageKills: 15.1, averageDeaths: 7.9, extractionRate: 40.0, bestStreak: 5, currentStreak: 3, timePlayed: '3h 47m' },
      last50: { matchesPlayed: 50, winRate: 66.0, kd: 1.84, kda: 2.29, averageKills: 14.5, averageDeaths: 7.9, extractionRate: 38.0, bestStreak: 8, currentStreak: 3, timePlayed: '18h 52m' },
      thisWeek: { matchesPlayed: 23, winRate: 73.9, kd: 2.01, kda: 2.52, averageKills: 15.8, averageDeaths: 7.9, extractionRate: 43.5, bestStreak: 7, currentStreak: 3, timePlayed: '8h 34m' },
      thisSeason: { matchesPlayed: 89, winRate: 70.8, kd: 1.93, kda: 2.39, averageKills: 14.9, averageDeaths: 7.7, extractionRate: 44.9, bestStreak: 12, currentStreak: 3, timePlayed: '33h 21m' },
    },
  },
  'player-002': {
    id: 'player-002',
