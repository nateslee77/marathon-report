...
export const detailedPlayers: Record<string, DetailedPlayer> = {
  'player-001': {
    ...
    loadout: [
      ...
      { slot: 'weapon3', name: 'Twin Tap HBR', icon: 'T', image: '/images/Weapons no bg/TWIN TAP HBR-Picsart-BackgroundRemover.png', rarity: 'prestige' },
  ...
  'player-002': {
    ...
    loadout: [
      ...
      { slot: 'sidearm', name: 'Magnum HC', icon: 'M', image: '/images/Weapons no bg/MAGNUM HC-Picsart-BackgroundRemover.png', rarity: 'enhanced' },
  ...
  'player-005': {
    ...
    loadout: [
      ...
      { slot: 'weapon3', name: 'V85 Circuit Breaker', icon: 'B', image: '/images/Weapons no bg/V85 CIRCUIT BREAKER-Picsart-BackgroundRemover.png', rarity: 'superior' },
  ...
  'player-024': {
    ...
    loadout: [
      { slot: 'primary', name: 'Overrun AR', icon: 'R', image: '/images/Weapons no bg/OVERRUN AR-Picsart-BackgroundRemover.png', rarity: 'prestige' },
      { slot: 'sidearm', name: 'Magnum HC', icon: 'M', image: '/images/Weapons no bg/MAGNUM HC-Picsart-BackgroundRemover.png', rarity: 'superior' },
      { slot: 'weapon3', name: 'Twin Tap HBR', icon: 'T', image: '/images/Weapons no bg/TWIN TAP HBR-Picsart-BackgroundRemover.png', rarity: 'prestige' },
      { slot: 'equipment', name: 'Frag Grenade', icon: 'G' },
      { slot: 'core', name: 'Guerrilla', icon: 'C' },
    ],
  ...
  'player-028': {
    ...
    loadout: [
      { slot: 'primary', name: 'Demolition HMG', icon: 'H', image: '/images/Weapons no bg/DEMOLITION HMG-Picsart-BackgroundRemover.png', rarity: 'deluxe' },
      { slot: 'sidearm', name: 'CE Tactical Sidearm', icon: 'S', image: '/images/Weapons no bg/CE TACTICAL SIDEARM-Picsart-BackgroundRemover.png', rarity: 'superior' },
      { slot: 'weapon3', name: 'Conquest LMG', icon: 'C', image: '/images/Weapons no bg/CONQUEST LMG-Picsart-BackgroundRemover.png', rarity: 'deluxe' },
      { slot: 'equipment', name: 'Claymore Mine', icon: 'M' },
      { slot: 'core', name: 'Bullrush', icon: 'C' },
    ],
    recentMatchSummary: [
