...
export const detailedPlayers: Record<string, DetailedPlayer> = {
  'player-001': {
    ...
    loadout: [
      ...
      { slot: 'weapon3', name: 'Twin Tap HBR', icon: 'T', image: '/images/weapons meta pics/TWIN TAP HBR.png' },
  ...
  'player-002': {
    ...
    loadout: [
      ...
      { slot: 'sidearm', name: 'Magnum HC', icon: 'M', image: '/images/weapons meta pics/MAGNUM HC.png' },
  ...
  'player-003': {
    ...
    loadout: [
      { slot: 'primary', name: 'WSTR Combat Shotgun', icon: 'S', image: '/images/weapons meta pics/WSTR COMBAT SHOTGUN.png' },
      { slot: 'sidearm', name: 'Hardline PR', icon: 'P', image: '/images/weapons meta pics/HARDLINE PR.png' },
  ...
  'player-004': {
    ...
    loadout: [
      { slot: 'primary', name: 'Demolition HMG', icon: 'H', image: '/images/weapons meta pics/DEMOLITION HMG.png' },
      { slot: 'sidearm', name: 'CE Tactical Sidearm', icon: 'S', image: '/images/weapons meta pics/CE TACTICAL SIDEARM.png' },
  ...
  'player-005': {
    ...
    lastUpdated: new Date(Date.now() - 1000 * 60 * 8),
    loadout: [
      { slot: 'primary', name: 'V22 Volt Thrower', icon: 'V', image: '/images/weapons meta pics/V22 VOLT THROWER.png' },
      { slot: 'sidearm', name: 'V11 Punch', icon: 'P', image: '/images/weapons meta pics/V11 PUNCH.png' },
      { slot: 'weapon3', name: 'V85 Circuit Breaker', icon: 'B', image: '/images/weapons meta pics/V85 CIRCUIT BREAKER.png' },
  ...
  'player-006': {
    ...
    loadout: [
      { slot: 'primary', name: 'Longshot', icon: 'L', image: '/images/weapons meta pics/LONGSHOT.png' },
      { slot: 'sidearm', name: 'Hardline PR', icon: 'P', image: '/images/weapons meta pics/HARDLINE PR.png' },
  ...
  'player-007': {
    ...
    loadout: [
      { slot: 'primary', name: 'BRRT SMG', icon: 'B', image: '/images/weapons meta pics/BRRT SMG.png' },
      { slot: 'sidearm', name: 'CE Tactical Sidearm', icon: 'S', image: '/images/weapons meta pics/CE TACTICAL SIDEARM.png' },
  ...
  'player-028': {
    ...
    loadout: [
      { slot: 'primary', name: 'Demolition HMG', icon: 'H', image: '/images/weapons meta pics/DEMOLITION HMG.png' },
      { slot: 'sidearm', name: 'CE Tactical Sidearm', icon: 'S', image: '/images/weapons meta pics/CE TACTICAL SIDEARM.png' },
      { slot: 'weapon3', name: 'Conquest LMG', icon: 'C', image: '/images/weapons meta pics/CONQUEST LMG.png' },
      { slot: 'equipment', name: 'Claymore Mine', icon: 'M' },
      { slot: 'core', name: 'Bullrush', icon: 'C' },
    ],
    recentMatchSummary: [
