...
const THEME_COLORS = [
  ...
  // Faction colors
  { name: 'CYBERACME', value: '#00ff00' },
  { name: 'SEKIGUCHI', value: '#43e9a0' },
  { name: 'TRAXUS', value: '#ff4b00' },
  { name: 'ARACHNE', value: '#df0008' },
  { name: 'NUCALORIC', value: '#ff0961' },
  { name: 'MIDA', value: '#665ead' },
];
